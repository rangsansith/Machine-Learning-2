...
public class GradientSpam {
	...
	public static void main(String[] args) {
		...
		for (int i = 11; i < 12; i++) {
			...
			//w[58]=2.2;
			double gte=100000.0,gtr=100000.0,tacc=9.9,tracc=0.0,septhresh=0.5,cte=0.0,ctr=0.0,thresh=0.000001;
			while(true)
			{
		...
		System.out.println("Average testing error:"+(msete/(double) 1));
		System.out.println("Average training error:"+(msetr/(double) 1));
